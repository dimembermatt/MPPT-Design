...
from design_procedures.passives_design import (
    get_inductor_core_loss,
    get_inductor_sizing,
    get_passive_sizing,
)
from design_procedures.switch_design import (
    get_switch_duty_cycle_map,
    get_switch_op_fs,
...
from sw.design_procedures.solar_cell_nonideal_model import model_nonideal_cell
